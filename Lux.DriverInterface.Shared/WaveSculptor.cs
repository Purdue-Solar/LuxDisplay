...
using Lux.DriverInterface.Shared.CanPackets.Wavescupltor;
using ErrorFlags = Lux.DriverInterface.Shared.CanPackets.Wavescupltor.Broadcast.Status.ErrorFlags;
using LimitFlags = Lux.DriverInterface.Shared.CanPackets.Wavescupltor.Broadcast.Status.LimitFlags;
